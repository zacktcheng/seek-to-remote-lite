...
public class Item {
	...
	public boolean equals(Object comparatorObj) {
		...
		if (this == comparatorObj) return true;
	    if (comparatorObj == null || getClass() != comparatorObj.getClass()) return false;

	    Item comparatorItem = (Item) comparatorObj;
	    
	    return Objects.equals(itemId, comparatorItem.itemId) &&
	    		Objects.equals(title, comparatorItem.title) &&
	    		Objects.equals(companyName, comparatorItem.companyName) &&
	    		Objects.equals(category, comparatorItem.category) &&
	            Objects.equals(url, comparatorItem.url) &&
